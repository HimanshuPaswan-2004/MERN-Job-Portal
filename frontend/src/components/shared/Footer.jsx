      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm">Connecting the best talent with top companies around the world. Your dream job is just a click away.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-4 text-foreground">For Candidates</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-foreground">For Employers</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-muted-foreground hover:text-[#F83002] transition-colors">
        ...
        <div className="mt-8 border-t border-border pt-8 text-center">
          <p className="text-muted-foreground text-sm">&copy; 2026 JobPortal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
